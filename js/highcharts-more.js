...
(function(m) {
        ...
        k.columnrange = u(k.arearange, {
            ...
            translate: function() {
                ...
                s(b.points, function(a) {
                    ...
                    l.height = f;
                    l.y = h;
                    a.tooltipPos = g.inverted ? [c.len + c.pos - g.plotLeft - h - f / 2, d.len + d.pos - g.plotTop - l.x - l.width /
                        2, f
    ...
    B = {
        ...
        translate: function() {
            ...
            s(this.points, function(d) {
                ...
                h && typeof h === "number" ?
                    (h = h / 180 * Math.PI, n = Math.max(a.startAngleRad - h, Math.min(a.endAngleRad + h, n))) : b.wrap === !1 && (n = Math.max(a.startAngleRad, Math.min(a.endAngleRad, n)));
                n = n * 180 / Math.PI;
                d.shapeType = "path";
                d.shapeArgs = {
    ...
    k.boxplot = u(k.column, {
        ...
        drawPoints: function() {
            var a = this,
                b = a.options,
                c = a.chart.renderer,
                d, g, e, j, l, i, f, h, n, k, m, H, I, o, t, r, v, u, w, x, B, A, y = a.doQuartiles !== !1,
    ...
    k.waterfall = u(k.column, {
        ...
        translate: function() {
            ...
            for (c = 0, a = d.length; c < a; c++) {
                ...
                if (e.height <= n) e.height =
                    n, this.minPointLengthOffset += n;
        ...
        processData: function(a) {
            ...
            for (h = 0; h < g; h++) f = b[h], d = c && c[h] ? c[h] : {}, f === "sum" || d.isSum ? b[h] = j : f === "intermediateSum" || d.isIntermediateSum ? b[h] = e : (j += f, e += f), l = Math.min(j, l), i = Math.max(j, i);
            w.prototype.processData.call(this,
                a);
            this.dataMin = l;
            this.dataMax = i
        },
    ...
    k.bubble = u(k.scatter, {
        ...
        drawLegendSymbol: function(a, b) {
            ...
            b.legendSymbol =
                c.circle(d, a.baseline - d, d).attr({
                    zIndex: 3
                }).add(b.legendGroup);
    ...
    L.prototype.beforePadding = function() {
        ...
        s(o, function(a) {
            ...
            if (k > 0)
                for (; c--;) typeof b[c] === "number" && (f = a.radii[c], d = Math.min((b[c] - l) *
                    m - f, d), g = Math.max((b[c] - l) * m + f, g))
        });
