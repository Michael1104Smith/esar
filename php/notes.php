...
<?php
    ...
    $dateAdded = "%20["."20140101000000"."%20TO%20".$endDate."]&fields=id,dateAdded,action,personReference,commentingPerson";

    $restUrl = $RT_Url->{"restUrl"};
    $queryUrl = "search/Note?query=dateAdded:".$dateAdded;
    ...
    $required_data_file = fopen("../data/notes.json","w");
