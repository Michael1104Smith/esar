...
<?php
    ...
    $dateAdded = "%20["."20140101000000"."%20TO%20".$endDate."]&fields=id,sendingUser,status,dateAdded";

    $restUrl = $RT_Url->{"restUrl"};
    $queryUrl = "search/JobSubmission?query=dateAdded:".$dateAdded;
    ...
    $required_data_file = fopen("../data/submissions.json","w");
